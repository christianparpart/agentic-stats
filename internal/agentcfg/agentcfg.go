...
type MeshConfig struct {
	...
	PSK string `toml:"psk"`
	// Name is what this node calls itself, for peers to label it by. The
	// hostname when unset, which is right until two nodes share one -- a
	// dual-boot machine, two VMs off one image, two accounts on one host. The
	// origin id keeps them apart underneath either way; this is what keeps
	// them apart in a report someone has to read.
